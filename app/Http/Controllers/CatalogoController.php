...
class CatalogoController extends Controller
{
    ...
    private $arrayPeliculas = array(
		array(
			...
			'poster' => 'https://www.elespectador.com/resizer/hAxEzT9PKnZTSewZ_8sSc4_NRTM=/525x350/filters:format(jpeg)/cloudfront-us-east-1.images.arcpublishing.com/elespectador/O6XDVCCX3BGMDH3VISEJ6POVSU.jpg', 
			'rented' => false, 
    ...
    public function getIndex() {
		...
		try {
			...
			drakify('success');
			//return view('catalog.index', ['arrayProductos' => $this->arrayProductos]);
			return view('catalog.index', ['arrayProductos' => $arrayProductos]);			
    ...
    public function getShow($id) {
        ...
        try {
			...
			$arrayProductos	=	Producto::all();
			//notify()->success('Producto editado exitosamente!');
			drakify('success');
			return view('catalog.show', ['arrayProductos' => $arrayProductos[$id]]);
